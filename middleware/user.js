...
exports.updatePasswordValidator = asyncHandler(async (req, res, next) => {
    ...
    const schema = joi.object().keys({
        ...
        confirmPassword: joi.string().required().min(6).equal(joi.ref('password')).messages({
            "string.base": "كلمة تأكيد السر يجب أن تكون نص",
            "string.min": "يجب ألا يقل عدد أحرف كلمة تأكيد سر عن 6 أحرف",
            "any.required": "يجب إدخال كلمة تأكيد المرور",
            "any.only":"كلمة المرور يجب أن تسوي كلمة تأكيد المرور"
        })
    })
