...
router.route('/login').post(getUserValidator, getUser)
router.route('/').post(authenticate, authorize, createUserValidator, createUser).put(authenticate, authorize, updateUserValidator, updateUser)
